...
> = {
  lease: { label: "Lease", fields: ["moveIn", "deposit"] },
  ...
  notice_of_violation: { label: "Notice of Violation", fields: ["reason"] },
  entry_notice: { label: "Entry Notice", fields: ["entryDate", "entryTime", "reason"] },
  notice: { label: "General Notice", fields: ["noticeBody"] },
  pay_or_quit: { label: "Pay or Quit", fields: ["amountDue"] },
  eviction_notice: { label: "Eviction Notice", fields: ["reason"] },
